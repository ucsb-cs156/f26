...
We will be doing a group activity (non-programming) in lecture Tuesday.  
* It does require your attendance/participation, and for the whole team to be present.
* There won't be time to get help with programming tasks until office hours (6:15-7:15), so please take advantage of the staff help *today*.
