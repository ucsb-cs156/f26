...
ready: true
layout: default
org: https://github.com/ucsb-cs156-f26
org_name: ucsb-cs156-f26
prev_assignment: P05
prev_assignent_link: https://ucsb-cs156.github.io/f26/hwk/p05/
canvas_link: https://ucsb.instructure.com/courses/tbd
sample_team: f26-03
---
...
({{page.due |  date: '%B %d, %Y at %l:%M %p' }}) (usually Monday of week 3),
